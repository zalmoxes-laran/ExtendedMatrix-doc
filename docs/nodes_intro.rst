...
.. note::
    ...
    To have a clearer idea about `WHY using stratigraphy is not archaeology-centered but it has a wider impact in the domain of Cultural Heritage <stratigraphic_approach>`_

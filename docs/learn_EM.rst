...
4. If you want to customize EM for your workflow
------------------------------------------------

* contributing to add some features you can start learning python for Blender `here <https://www.youtube.com/watch?v=rKGNc6CQ2cg>`_ (in italian, with english subtitles) and asking to the EM community on Facebook or Telegram.
  
* porting EM on other platforms like Revit, 3DStudioMax, Unity or Unreal, consider to use the python library s3Dgraphy starting from its documentation (*coming soon*).
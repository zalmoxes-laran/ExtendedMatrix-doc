...
The canvas enables one of the most powerful features of the Extended Matrix formal language: the data funnel. It is recommended to thoroughly understand the fundamental concepts and analytical components presented so far, before `exploring the advanced concept of data funnels <https://docs.extendedmatrix.org/en/1.5.0dev/data_funnel.html>`_.

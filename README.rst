...
`extendedmatrix.org <https://extendedmatrix.org>`_, and for the 1.5
release write-up see `What's new in 1.5
<https://extendedmatrix.org/versions/1-5/>`_.
...
2. Fork the repository and create a feature branch off the appropriate
   release branch (typically ``1.5.0`` for the current LTS, or ``1.6``
   for upcoming-release content).
